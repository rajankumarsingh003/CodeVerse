...
//     setResponseBlocks([]);
//     setActiveSession(null);
//     toast.info("🆕 New Debugger Chat Started!");
//   };

//   return (
//     <div className="flex bg-gradient-to-b from-[#0B0B0F] via-[#101019] to-[#0B0B0F] text-white min-h-screen">
//       {/* 🧩 Sidebar */}
//       <div className="w-64 bg-[#151521]/90 border-r border-cyan-500/20 p-4 backdrop-blur-md shadow-[0_0_15px_#0ff3]">
...
//           <div
//             key={s.id}
//             className={`cursor-pointer p-3 mb-2 rounded-lg transition-all duration-300 ${
...
//               Your personal AI engineer for code perfection
//             </p>
//           </div>
//         </div>

//         <div className="rounded-xl border border-cyan-400/10 bg-[#141421]/60 backdrop-blur-md shadow-[0_0_25px_#00c6ff20] overflow-hidden">
//           <Editor
//             height="320px"
//             language="javascript"
//             theme="vs-dark"
...
//             onClick={analyzeCode}
//             disabled={loading}
//             className="bg-gradient-to-r from-purple-600 to-cyan-600 px-8 py-3 rounded-lg text-white font-semibold hover:shadow-[0_0_25px_#00c6ff80] hover:scale-105 transition-all duration-300 flex items-center gap-2"
//           >
//             {loading ? <ClipLoader color="white" size={18} /> : "⚡ Analyze Code"}
//           </button>
//         </div>

//         {responseBlocks.length > 0 && (
//           <div className="mt-8 bg-[#151521]/80 border border-cyan-500/20 rounded-xl p-6 shadow-[0_0_20px_#00c6ff20] max-h-[500px] overflow-y-auto">
...
//                 <p
//                   key={idx}
//                   className="text-gray-200 whitespace-pre-wrap leading-relaxed mb-4"
//                 >
//                   {block.content}
//                 </p>
//               ) : (
//                 <div
//                   key={idx}
//                   className="relative bg-[#0D0D12] border border-gray-700 rounded-lg mb-5 overflow-hidden"
//                 >
...
// uper lower code will work good
...
//             className="bg-[#1E1E26] text-white px-4 py-2 rounded-lg border border-cyan-400/30"
//           >
...
// upper code is new professional working code
