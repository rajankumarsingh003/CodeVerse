...
//       {/* 🔹 Main Section */}
//       <div className="max-w-7xl mx-auto px-8 flex flex-col md:flex-row items-center justify-between gap-6 relative z-10">

//         {/* Center — Socials */}
//         <div className="flex gap-8 text-2xl justify-center md:justify-start">
//           <a
//             href="https://github.com/"
//             target="_blank"
//             rel="noopener noreferrer"
//             className="hover:scale-125 transition-transform duration-500 text-gray-400 hover:text-cyan-400 drop-shadow-[0_0_8px_#00c6ff]"
//           >
//             <FaGithub />
//           </a>
//           <a
...
//             target="_blank"
//             rel="noopener noreferrer"
//             className="hover:scale-125 transition-transform duration-500 text-gray-400 hover:text-sky-400 drop-shadow-[0_0_8px_#00c6ff]"
//           >
//             <FaTwitter />
//           </a>
//           <a
...
//             target="_blank"
//             rel="noopener noreferrer"
//             className="hover:scale-125 transition-transform duration-500 text-gray-400 hover:text-blue-500 drop-shadow-[0_0_8px_#00c6ff]"
//           >
//             <FaLinkedin />
//           </a>
//         </div>
...
//         {/* Right — Credits */}
//         <div className="text-sm text-gray-400 text-center md:text-right mt-5 md:mt-0">
//           <p>
//             Built with ❤️ by{" "}
//             <span className="text-cyan-400 font-semibold hover:text-purple-400 transition-all duration-300">
//               Rajan Kumar Singh
//             </span>
//           </p>
...
//       {/* 🔹 Bottom Glow Line */}
//       <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[80%] h-[1px] bg-gradient-to-r from-transparent via-cyan-500 to-transparent blur-md opacity-60"></div>
//     </footer>
//   );
// };
